      ...
      <nav className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <button onClick={onBackToVenues} className="text-gray-700 hover:text-teal-600 font-medium">
              ← Back to Venues
            </button>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Experience top-quality sports facilities at {venue.name}. Our well-maintained courts provide the
                  perfect environment for your game. Whether you're a beginner or a professional, our venue offers
                  everything you need for an excellent sporting experience.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Showing 8 of {timeSlots.filter((slot) => slot.available).length} available slots
                </p>
              </div>
